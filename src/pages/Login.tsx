    ...
    <div className="min-h-screen bg-dark-900 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-400">
          Or{' '}
          <Link to="/signup" className="font-medium text-glow-purple hover:text-purple-400 transition-colors">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  name="remember-me"
                  type="checkbox"
                  className="h-4 w-4 text-glow-purple focus:ring-glow-purple bg-dark-700 border-dark-500 rounded"
                />
              ...
              <div className="text-sm">
                <a href="#" className="font-medium text-glow-purple hover:text-purple-400 transition-colors">
